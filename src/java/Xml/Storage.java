...
//import java.entities.Company;
//import java.entities.Job;
//import java.entities.Person;
//import java.entities.Response;
...
//            p.setPerson_id(Integer.parseInt(s.next()));
//            System.out.println("Enter First name");
//            p.setFirst_name(s.next());
//            System.out.println("Enter Last name");
//            p.setLast_name(s.next());
//            System.out.println("Enter rating");
//            p.setRating(Float.parseFloat(s.next()));
...
//            p.setCompanies_company_id(Integer.parseInt(s.next()));
//            System.out.println("Enter job id");
//            p.setJobs_job_id(Integer.parseInt(s.next()));
