...
public class Person {
    ...
    public  Person(int person_id, String first_name, String last_name, float rating, int age, String status, String login, String password, String email, int companies_company_id, int jobs_job_id) {
